...
Item {
    ...
    Item {
        ...
        ListView {
            ...
            ShaderEffectSource {
                id: coverNmapSource
                sourceItem: Image { source: "qrc:/content/images/cover_nmap.png" }
                hideSource: true
                visible: false
            }
            ...
            anchors.fill: parent
            spacing: -60
            model: moviesModel // blueRayModel
            ...
            Connections{
                target:detailsView
                onOrderedChanged: {
                    listView.currentItem.delegatData.ordered=!listView.currentItem.delegatData.ordered
                }
            }
        }
        ...
        Image {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            source: "qrc:/content/images/qt_logo.png"
        ...
        AnimatedSprite {
            ...
            frameCount: 16
            frameRate: 15
            source: "qrc:/content/images/planet_sprite.png"
            interpolate: true
        ...
        ParticleSystem {
            ...
            ImageParticle {
                source: "qrc:/content/images/particle.png"
                color: "#ffefaf"
            ...
            ImageParticle {
                groups: ["smoke"]
                source: "qrc:/content/images/smoke.png"
                color: "#ffffff"
                alpha: 0.9
                opacity: 0.5
