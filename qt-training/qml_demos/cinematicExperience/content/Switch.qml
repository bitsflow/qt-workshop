...
Item {
    ...
    Image {
        ...
        source: "qrc:/content/images/switch_background.png"
        anchors.verticalCenter: parent.verticalCenter
    ...
    Image {
        id: switchFrameImage
        source: "qrc:/content/images/switch_frame.png"
        anchors.verticalCenter: parent.verticalCenter
        anchors.right: parent.right
    ...
    Item {
        ...
        Image {
            ...
            source: "qrc:/content/images/switch_on.png"
            opacity: knob.x / 48
            ...
            ParticleSystem {
                ...
                ImageParticle {
                    source: "qrc:/content/images/star.png"
        ...
        Image {
            id: knob
            source: "qrc:/content/images/switch_thumb.png"
            x: checked ? 48 : -2
            opacity: 0.4
            MouseArea {
                anchors.fill: parent
